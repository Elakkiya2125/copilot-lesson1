        ...
        if (details.participants.length > 0) {
          participantsHTML += details.participants.map(email => `
            <li style="display:flex;align-items:center;gap:6px;">
              <span>${email}</span>
              <span class="delete-participant" title="Remove" data-activity="${name}" data-email="${email}" style="color:#c62828;cursor:pointer;font-size:1.1em;user-select:none;margin-left:6px;">&#128465;</span>
            </li>
          `).join("");
        } else {
